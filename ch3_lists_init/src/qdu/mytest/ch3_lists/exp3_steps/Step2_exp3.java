...
public class Step2_exp3 extends Activity{
	//定义名字数组
...
{R.drawable.icon1,R.drawable.icon2,R.drawable.icon3};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.step2_exp3);
        ...
        BaseAdapter ba =new Mybaseadp2(this,list);
        ListView mylv = (ListView)this.findViewById(R.id.exp3_step2_lv);
        if(ba != null)
            mylv.setAdapter(ba);
	}
}
